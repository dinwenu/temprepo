...
MODEL_DIR="../../results"
MODEL="gpt2_12-5b"
CONFIG="../../../model_lib/gpt2_configs/gpt2-12-5-billion.json"
OUT_DIR="./logs/${MODEL}"
mkdir -p ${OUT_DIR}
# --------------------------------------------
# for SCHEDULED in "D16_vDP_N4_Top1" "D16_vPP_N4_Top1" "D64_vDP_N4_Top1" "D64_vPP_N4_Top1" "D256_vDP_N4_Top1" "D256_vPP_N4_Top1"
for SCHEDULED in D4_vPP_N4_Ufwd1_Ubwd1_P1 # D32_vPP_N4_Ufwd1_Ubwd1_P2 # "D32_vPP_N4_Top1_gpt2_10b_3090"
do
